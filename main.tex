...
\def\Estudiante{Sergio Perea de la Casa}

% ==== Introducir aquí el nombre de los tutores. Si solo hay uno dejar las llaves de \TutorB vacías
\def\TutorA{María José del Jesús Diáz.}
\def\TutorB{Francisco Charte Ojeda.}
...
\def\TituloAbreviado{Autoencoders generativos.}
...
\input{Desarrollo de Aprendizaje.tex}
\clearpage\thispagestyle{empty}\cleardoublepage
